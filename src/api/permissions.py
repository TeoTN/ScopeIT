...
class IsObjectOwnerOrAdmin(BasePermission):
    ...
    def has_permission(self, request, view):
        return view.action == 'retrieve' or request.user.is_staff or request.user.is_superuser
...
class IsAdminOrReadOnly(BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return request.user.is_staff or request.user.is_superuser or request.method in SAFE_METHODS